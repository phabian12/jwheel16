...
public class BookDAOHelperIntegration {
	...
	/* these methods are all essentially the same
	* however searching for different values within the Book Entity */
	...
	public void testBookMapFindByAuthor() {
	    ...
	    assertEquals("Stephen King", bookList_.get(0).getAuthor());
	    assertEquals("The Dark Tower", bookList_.get(0).getTitle());
	    assertEquals("KF8840", bookList_.get(0).getCallNumber());
	    assertEquals(1, bookList_.get(0).getID());
	}
